<template>
    ...
    <div uk-modal :id="'modal' + modalIdMaker(novel.Title)">
        <div class="uk-modal-dialog uk-modal-body uk-text-center">
            ...
            <h4 class="bottomMargin" v-if="novel.Author">
                Author: {{ novel.Author }}
            </h4>
            ...
            <p class="modalDescription" v-if="novel.Review">
                {{ novel.Review }}
            </p>
            <h4>Description</h4>
            <p class="modalDescription">{{ novel.Description }}</p>
            <a :href="novel.Link" target="_blank">
                <button class="uk-button uk-button-primary modalLinkButton">
                    Novel Link
                </button>
            </a>
        </div>
